...
public class AjoutRendre extends javax.swing.JDialog {
    ...
    public void deroulante_Rendre()
    {
        ...
        datePayer.setText(formattedDate);
 
        try
        {
           conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/banque","root","");
           preparer = conn.prepareStatement("SELECT * FROM PRETER");
           resultat = preparer.executeQuery();
            while (resultat.next()) 
            {
              String num_Compte = resultat.getString("num_Compte");
              NumPrete.addItem(num_Compte);
            }
        } 
    ...
    private void initComponents() {
        ...
        datePayer = new javax.swing.JTextField();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(datePayer, javax.swing.GroupLayout.DEFAULT_SIZE, 226, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(27, 27, 27)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(datePayer, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel5))
                .addGap(45, 45, 45)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(AjoutRendre)
    ...
    private void AjoutRendreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AjoutRendreActionPerformed
         ...
         try
        {
            ...
            reste = conn.prepareStatement("SELECT rest_payé FROM RENDRE WHERE num_pret = ?");
            reste.setString(1, NumPrete.getSelectedItem().toString());
            ...
            float montant_a_payer = Float.parseFloat(MontPayer.getText());
            float reste_payer = resteprete-montant_a_payer ;
            String situation= ("payer moitier");
            
            //UPDATE RENDRE SET situation = ?, rest_payé = ? WHERE num_rendu = ? AND num_pret = ?            
            reste = conn.prepareStatement("UPDATE RENDRE SET situation = ?, rest_payé = ? WHERE num_pret = ?");
            reste.setString(1, situation);
            reste.setFloat(2,reste_payer);
            reste.setString(3, NumPrete.getSelectedItem().toString());
            reste.executeUpdate();
            
            conn.setAutoCommit(false);
             //Récupération le solde client
            preteur = conn.prepareStatement("SELECT SOLDET FROM CLIENT WHERE numCompte = ?");
            preteur.setString(1, NumPrete.getSelectedItem().toString());
            ...
            Client.setString(2,NumPrete.getSelectedItem().toString());
    ...
    private javax.swing.JTextField datePayer;
